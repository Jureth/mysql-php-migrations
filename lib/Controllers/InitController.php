...
class InitController extends BaseController
{
    ...
    public function doAction()
    {
        ...
        do {
            echo "\nWhich method would you like to use to connect to\nthe database?  " . MPM::METHOD_PDO . "=PDO or " . MPM::METHOD_MYSQLi . "=MySQLi";
            if (isset($db_config)) {
        ...
        } while ($method < MPM::METHOD_PDO || $method > MPM::METHOD_MYSQLi || $method == 0);
        ...
        MPM::init(require(MPM_PATH . '/config/db_config.php'));
        ...
        try {
            if (false === DbHelper::checkForDbTable()) {
                ...
                if (NULL !== $msg = DbHelper::createMigrationTable()) {
                    echo "failure!\n\n" . 'Unable to create required ' . $migrations_table . ' table:' . $msg;
                    echo "\n\n";
                    exit;
                }
                echo "done.\n\n";
